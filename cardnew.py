...
class cardDetail(QDialog):
    ...
    def setupUi(self):
        ...
        # Form with loop for holes to add
        #  Don't add in a first step, waiting to have the course selected

        self.lbl_hole_1 = QtWidgets.QLabel("Trou 1")
        self.gridLayout.addWidget(self.lbl_hole_1, 5, 0, 2, 1)
        self.cmb_hole_1 = QtWidgets.QComboBox()
        self.gridLayout.addWidget(self.cmb_hole_1, 5, 1, 2, 2)
        self.lbl_club_1 = QtWidgets.QLabel("Club")
        self.gridLayout.addWidget(self.lbl_club_1, 5, 3, 2, 1)
        self.cmb_club_1 = QtWidgets.QComboBox()
        self.gridLayout.addWidget(self.cmb_club_1, 5, 4, 2, 2)
        self.chk_farway_1 = QtWidgets.QCheckBox("Fairway")
        self.gridLayout.addWidget(self.chk_farway_1, 5, 6, 2, 2)
        self.chk_green_1 = QtWidgets.QCheckBox("Green")
        self.gridLayout.addWidget(self.chk_green_1, 5, 8, 2, 2)
        self.txt_comment_1 = QtWidgets.QTextEdit("")
        self.gridLayout.addWidget(self.txt_comment_1, 7, 0, 1, 10)
        ...
        self.btn_valid.accepted.connect(self.newBdd)
    ...
    def nbHoles(self, course):
        hole_number = self.bddConnect("SELECT coursesholes FROM courses WHERE courses.idcourses = " + course)

        print(hole_number.fetchone())
